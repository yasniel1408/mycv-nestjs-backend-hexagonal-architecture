...
import { ICreateReportController } from '@src/reports/domain/ports/primary/http/create-report.controller.interface';
import { CreateReportRequestDto } from './dto/report.request.dto';
import { CreatedReportRequestDto } from './dto/report.response.dto';
import { CreateReportService } from '@src/reports/application/create-report/create-report.service';
